...
def breast_cancer_predict():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if(prediction[0]==1):
                return render_template('Result.html', prediction_text=f'96% chance a tumour has been diagnosed as malignant')
            else:
                return render_template('Result.html', prediction_text=f'96% chance the tumour has been diagnosed as benign')
        except:
...
def echocardiogramAnalysis():
    ...
    if request.method == 'GET':
       ...
       'wall-motion-index'])
            ...
            if(prediction[0]==0):
                return render_template('Result.html', prediction_text=f'94% chance the patient will not survive for atleast one year')
            else:
                return render_template('Result.html', prediction_text=f'94% chance the patient will survive for atleast one year')
        except:
            print("Please enter the details first !!", "danger")      
...
def hemmorhageCheck():
     if request.method == 'GET':
        ...
        if(a==0):
            preds="93.33% chance the patient does not have Brain Hemmorhage."
        else:
             preds="93.33% chance the patient is diagnosed with Brain Hemmorhage"
        return preds
...
def heart_failure_predict():
 ...
 'platelets','serum_creatinine','serum_sodium','smoking','time'])      
            ...
            if(prediction[0]==1):
                #return render_template('Result.html', prediction_text=f'Resume.pdf')
                return render_template('Result.html', prediction_text=f'87% chances of the patient to suffer a heart failure in the future')
            else:
                return render_template('Result.html', prediction_text=f'87% chances of the patient to not suffer a heart failure in the future')
        except:
            print("Please enter the details first !!", "danger")   
...
def hypertension_predict():
    ...
    if request.method == 'GET':
       ...
       'DIABETES'])
            ...
            if (prediction[0]==0):
                return render_template('Result.html', prediction_text=f"70% chances the patient is not suffering from hypertension")
            else:
                return render_template('Result.html', prediction_text=f"70% chances the patient is suffering from hypertension")
        except:
            print("Please enter the details first !!", "danger")     
...
def stroke_predict():
    ...
    if request.method == 'GET':
       ...
       'Residence_type_Urban', 'smoking_status'])   
            ...
            if(prediction[0]==1):
                return render_template('Result.html', prediction_text=f'Unfortunately,the patient is likely to encounter a stroke in the future time with an accuracy of 100%')
            else:
                return render_template('Result.html', prediction_text=f'Fortunately, the patient is not likely to encounter a stroke in the future time with an accuracy of 100%')
        except:
            print("Please enter the details first !!", "danger") 
...
def diabetes_predict():
    ...
    if request.method == 'GET':
       ...
       'BMI', 'DiabetesPedigreeFunction', 'Age'])
            ...
            if (prediction[0][0]==0):
                return render_template('Result.html', prediction_text=f"Congratulations,76% chance that the patient is not diagnosed with diabetes")
            else:
                return render_template('Result.html', prediction_text=f"Unfortunately,76% chance that the patient is diagnosed with diabetes")
        except:
            print("Please enter the details first !!", "danger")  
...
def plantarFascitis():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if(prediction[0]==0):
                return render_template('Result.html', prediction_text=f'94% chance that the patient is not diagnosed with Plantar Fascitis')
            else:
                return render_template('Result.html', prediction_text=f'94% chance that the patinet is diagnosed with Plantar Fascitis')
        except:
            print("Please enter the details first !!", "danger")      
...
def fertility_predict():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if (prediction[0]==0):
                return render_template('Result.html', prediction_text=f"Congratulations, with an accuracy of 94% the semen sample is normal")
            else:
                return render_template('Result.html', prediction_text=f"Unfortunately, with an accuracy of 94% the semen sample is not normal citing a possibiliy of asthenozoospermia or oligozoospermia")
        except:
            print("Please enter the details first !!", "danger")  
...
if __name__ == "__main__":
    app.run(debug=True,port=random.randint(999, 9999))